...
- **개인정보처리방침**: [개인정보처리방침 보기](./privacy-policy.html)
...
- **MediaPlayer 한계 극복**  
  기존 내장 MediaPlayer는 복잡한 UI/UX, 커스텀 컨트롤, 상태 동기화에 한계 →  
  확장성 높은 Media3 + ExoPlayer 채택, 안정적인 오디오 앱 UX 구현

- **플레이어 MotionLayout 구현**  
  플레이어 축소/확장, 모션/Constraint 세팅에 난항 →  
...
- 뮤직 플레이어 앱 특성상 다양한 Android 버전, Permission/Service 이슈가 있었으나 최신 패턴과 라이브러리 활용으로 개선
- MVVM 아키텍처, Hilt 도입으로 추후 유지보수성과 확장성 향상을 경험
